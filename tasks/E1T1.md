...
Create User table with telegram_user_id (PK), display_name, timezone, main_message_id (nullable), created_at. Add validation for timezone format during creation.
