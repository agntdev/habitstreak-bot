# E9T1 — Streak Computation

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 HSTK

For each habit, calculate current streak by counting consecutive completed dates. Track longest streak in Habit table. Update both when DailyRecord is completed. Append to tests/commands.json. Write tests/specs/E9T1.json for streak logic.
