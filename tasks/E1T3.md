# E1T3 — DailyRecord Table

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 HSTK

Create DailyRecord table with id (PK), habit_id (FK to Habit), date (YYYY-MM-DD in user timezone), count (integer), completed (bool). Add unique constraint on (habit_id, date).
