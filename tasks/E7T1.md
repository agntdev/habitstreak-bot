# E7T1 — Message Layout Components

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 HSTK

Implement header line, habit rows with 'X/Y today' format, and footer buttons. Use emojis as specified. Write tests/specs/E7T1.json for message structure validation.
