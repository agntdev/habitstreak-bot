# E6T1 — Streak Statistics Display

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 HSTK

Calculate and format today's completion rate (completed habits/total). Show each habit's current and longest streaks. Display overall longest streak across all habits. Append to tests/commands.json. Write tests/specs/E6T1.json for stats display.
