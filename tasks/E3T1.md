# E3T1 — Habit Name Input

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 HSTK

First step: prompt user to type habit name. Store in session state. Append to tests/commands.json. Write tests/specs/E3T1.json for name input validation.
