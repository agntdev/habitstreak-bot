# E5T2 — Streak Update Logic

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 HSTK

When count reaches target, mark DailyRecord.completed. Calculate current streak by checking consecutive completed dates. Update longest_streak if current streak is longer. Append to tests/commands.json. Write tests/specs/E5T2.json for streak logic.
