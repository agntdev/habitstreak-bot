...
When user is new, prompt for timezone input. Create initial main message with [Add habit], [Stats], [Help] buttons. Store message_id in User table. Write tests/specs/E2T1.json for this flow.
