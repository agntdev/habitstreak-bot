# E4T1 — Habit Progress Display

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 HSTK

Fetch all active habits and their today's count from DailyRecord. Format each row with 'X/Y today' and current streak. Append to tests/commands.json. Write tests/specs/E4T1.json for progress display.
