# E3T2 — Target Selection UI

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 HSTK

Second step: present inline buttons for targets 1-5 and 'Custom'. For custom, validate numeric input (1-20). Store target in session. Write tests/specs/E3T2.json for button interactions.
