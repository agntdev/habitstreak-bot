...
Create Habit table with id (PK), user_id (FK to User), name (max 100 chars), target_per_day (integer ≥1), created_at, active (bool). Add constraint for max 100 active habits per user.
