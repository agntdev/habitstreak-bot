# E8T1 — Timezone Validation

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 HSTK

Validate user-provided timezone strings against IANA database or UTC offset format. Store in User table. Write tests/specs/E8T1.json for timezone validation scenarios.
