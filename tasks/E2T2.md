# E2T2 — Existing User Handling

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 HSTK

When user exists, edit stored main message to show current habits and streaks. Append to tests/commands.json with /start command. Write tests/specs/E2T2.json for editing existing message.
