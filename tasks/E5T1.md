# E5T1 — Count Increment Logic

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 HSTK

When '✓ Done' pressed, increment DailyRecord.count for current day. If count < target, update progress in main message. Append to tests/commands.json. Write tests/specs/E5T1.json for count tracking.
